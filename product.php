                    ...
                    <div class="col-md-7">
                        <div class="product-detail">
                            ...
                            <form>
                                ...
                                <?php if($has_template): ?>
                                    <a href="<?php echo $lumise->cfg->url.'add-cart.php?product='.$value['id']; ?>&name=" class="lumise-add">
	                                    <?php echo $lumise->lang('Add to cart'); ?>
	                                </a>
                                <?php endif; ?>
                                <a href="<?php echo $lumise->cfg->tool_url.'?product='.$value['id']; ?>&name=" class="lumise-custom">
